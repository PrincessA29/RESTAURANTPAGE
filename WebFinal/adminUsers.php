...
<div class="nav">
    <ul>
    <li><button class="notactivepage"><a href="admin.php"><b>List of Reservations</b></a></button></li>
    <li><button class="activepage"><a href="adminUsers.php"><b>List of Users</b></a></button></li>
...
<div class="container">
        ...
        if ($result->num_rows > 0) {
            while ($row = $result->fetch_assoc()) {
                ...
                echo "<td><button class='delete' onclick=\"removeRow(" . $row["USER_ID"] . ")\">Delete</button></td>";
                echo "</tr>";
            }
        } else {
