...
<body>
    ...
    <div class="nav">
    <ul>
    <li><button><a href="menu2.php"><b>Menu</b></a></button></li>
    <li><button><a href="feedback.php"><b>Feedback</b></a></button></li>
    ...
    <div class="desc2">
        ...
        <a href="scheduling.php"><button><b>Set a Schedule</b></button></a>
        </div>
    </div>
